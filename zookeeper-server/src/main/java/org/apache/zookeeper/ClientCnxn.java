...
//            packet放到outgoingQueue队列中
        ...
        @Override
        public void run() {
            //todo 设置sessionId与outgoingQueue队列
            ...
            //todo 10 seconds //默认时间间隔
            final int MAX_SEND_PING_INTERVAL = 10000;
            InetSocketAddress serverAddress = null;
            //todo 连接未关闭 循环
            while (state.isAlive()) {
                try {
                    //todo //是否已连接，初始未连接，执行此处逻辑
